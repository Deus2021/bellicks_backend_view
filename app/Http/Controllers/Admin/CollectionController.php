...
class CollectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->success([
            'repayment_today' =>
            $total_expected_of_day_for_loan_not_paid_at_all,
    ...
    public function loans()
    {
        ...
        return [
            'loans_today' => $loans_today->sum('loan_amount'),
            'loans_week' => $loans_week->sum('loan_amount'),
            'loans_month' => $loans_month->sum('loan_amount'),
            'loans_year' => $loans_year->sum('loan_amount'),
            'total_loans' => $total_loans->sum('loan_amount'),
